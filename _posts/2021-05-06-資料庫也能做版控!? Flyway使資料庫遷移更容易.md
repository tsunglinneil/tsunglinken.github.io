...
<div><img src="{{site.baseurl}}/images/flyway/agenda.png" width="800" height="150" alt=""></div>
...
<div><img src="{{site.baseurl}}/images/testcontainers/flyway/java-migration1.png" width="800" height="150" alt=""></div>
...
│ │ │ └── db
│ │ │ └── migration
│ │ │ └── R**java_base_migration_sample.java
│ │ └── resources
│ │ ├── doc
│ │ │ ├── migration
│ │ │ │ └── common
│ │ │ │ ├── V1.0**sql_base_migration_ddl.sql
│ │ │ │ ├── V1.1\_\_sql_base_migration_dml.sql
```
